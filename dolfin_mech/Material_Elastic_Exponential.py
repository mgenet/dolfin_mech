...
class ExponentialMaterial(ElasticMaterial):
    ...
    def __init__(self,
        ...
        if   (self.kinematics.dim == 2):
                ...
                self.Psi   =  self.beta1/self.beta2/self.alpha/2 * dolfin.exp(self.beta2*(self.kinematics.IC - 2 - 2*dolfin.ln(self.kinematics.J))**self.alpha) \
            ...
            self.Psi   =  self.beta1/self.beta2/self.alpha/2 * dolfin.exp(self.beta2*(self.kinematics.IC - 3 - 2*dolfin.ln(self.kinematics.J))**self.alpha) \
